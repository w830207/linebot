...
def handle_message(event):
	...
	if event.message.text  in dictW:
			message = TextSendMessage(text=book("西屯區",dictM[event.message.text]))
			line_bot_api.reply_message(event.reply_token, message)
	elif event.message.text  in dictM:
			message = TextSendMessage(text=book("中區",dictM[event.message.text]))
			line_bot_api.reply_message(event.reply_token, message)
	elif event.message.text  in dictN:
			message = TextSendMessage(text=book("北區",dictM[event.message.text]))
			line_bot_api.reply_message(event.reply_token, message)
